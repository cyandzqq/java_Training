...
public class SpringBootMybatisApplicationTests {
    ...
    public void selectstudentbymap(){
    	...
    	map.put("name","cy" );
    	map.put("age", 20);
    	List<Student> s=studentmapper.selectstudentbymap(map);
    	for(int i=0;i<s.size();i++){
    		int classid=studentmapper.selectclassidbyid(s.get(i).getStuId());
    		System.out.println(s.get(i).toString()+",classid="+classid);
    	}
